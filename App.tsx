...
const App: React.FC = () => {
  // Draft State (User Inputs)
  const [segments, setSegments] = useState<MotionSegment[]>([
    { id: '1', type: MotionType.CYCLOIDAL, endAngle: 120, endLift: 20 },
    { id: '2', type: MotionType.DWELL, endAngle: 240, endLift: 20 },
    { id: '3', type: MotionType.HARMONIC, endAngle: 360, endLift: 0 },
  ]);
  ...
  const handleCalculate = () => {
    const mData = calculateMotion(segments);
      ...
      <main className="flex-1 container mx-auto p-4 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 xl:col-span-3 flex flex-col gap-6 h-[calc(100vh-120px)] lg:h-auto">
          ...
          <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
            {activeTab === 'motion' ? (
              <MotionDesigner segments={segments} onSegmentsChange={setSegments} />
            ) : (
        ...
        <div className="lg:col-span-8 xl:col-span-9 flex flex-col gap-6">
          ...
          <section className="space-y-4">
             <Charts data={motionData} currentTheta={currentTheta} />
          </section>
